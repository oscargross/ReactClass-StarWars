                ...
                <div className="container">
                    ...
                    <CardDeck>
                        <Card>
                            ...
                            <Card.Footer>
                                <a target="_blank" rel="noopener noreferrer" href="https://www.instagram.com/oscar.gross/"><InstagramIcon className="icon"></InstagramIcon></a>
                                <a target="_blank" rel="noopener noreferrer" href="https://www.facebook.com/oscar.gross.5/"><FacebookIcon className="icon"></FacebookIcon></a>
                                <a target="_blank" rel="noopener noreferrer" href="https://www.linkedin.com/in/oscar-gross-891534137/"><LinkedInIcon className="icon"></LinkedInIcon></a>
                                <a target="_blank" rel="noopener noreferrer" href="https://twitter.com/"><TwitterIcon className="icon"></TwitterIcon></a>
                            </Card.Footer>
                        </Card>
                        <Card>
