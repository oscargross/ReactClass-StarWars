                ...
                <div className="row footer_inner">
                    <div className="col-lg-6 col-sm-6">
                        <aside className="f_widget ab_widget">
                            ...
                            <p>Copyright &copy; Todos os direitos reservador | Esse template tem base no Woodrox e foi modificado <i className="fa fa-heart-o" aria-hidden="true"></i>por <a href="https://DevOscarFelipe.com" >Oscar e Felipe</a>
                            </p>
                        </aside>
                    </div>
